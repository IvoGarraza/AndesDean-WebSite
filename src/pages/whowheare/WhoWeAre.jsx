    ...
    <div className="flex flex-col items-center justify-center">
      ...
      <div className="flex sm:flex-row flex-col items-center justify-center my-8">
        <div className="py-6 sm:w-[40%] px-6 sm:px-0">
          ...
          <p className="font-medium text-justify">
            Diego, a highly experienced professional engineer with over 15 years
            of expertise in the AEC industry, isrenowned for his leadership and
            adaprabily. He has successtully delivered intercscipinary projects,
            leveraging cutting:dge technologies on both local nd internat sces.
            As the Founder and CEO of Andes Dean Engineering Studio, Diego has
            spent the last 10 years assembling a highly sled team that shares
            his passion for innovation and embraces new challenges. Specializing
            in project management, the studio covers design development,
            permits, and construction documentation. Diego's proficiency extends
            to architectural and engineering. projects, slang. with providing
            international AEC backoffice support, ensuring Nawles execution and
            top-qualty outcomes
          </p>
        </div>
      ...
      <div className="flex flex-col sm:flex-row items-center justify-around my-6">
        <div className="sm:w-[40%] w-full flex flex-col items-center">
          <h3 className="font-bold text-4xl text-primary my-2">Meet the team</h3>
          ...
          <span className="text-justify px-6 font-medium">
            ...
            modeling and documentation services. By leveraging cutting edge tools
            like BM software, we ensure precise virtual representations of
