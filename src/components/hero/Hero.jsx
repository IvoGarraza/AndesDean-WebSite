  ...
  return (
    ...
    >
      ...
      <div className="w-full h-full items-center justify-center flex flex-col">
        ...
        <div className="shape absolute sm:flex  bottom-0 left-0 sm:w-1/3 w-1/2 sm:h-full h-1/2 bg-[#a22224b7] z-0"></div>
        <div className="shape2 absolute sm:flex top-0 right-0 sm:w-1/3 w-1/2 sm:h-full h-1/2 bg-[#052a49ce] z-0"></div>
      {/* <div class='shape'></div> */}
    </div>
  );
};
