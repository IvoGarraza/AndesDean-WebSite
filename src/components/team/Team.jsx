  ...
  return (
    <div class="container">
      <div class="wrap my-2 flex flex-row w-full justify-between h-1/5">
        ...
        <div class="flex flex-row justify-around w-4/5 grayscale hover:grayscale-0">
          <img
            className="w-1/3 p-2"
          ...
          />
          <img className="w-1/3 p-2" src={diego2} />
        </div>
      </div>
      <div class="wrap2 my-2 flex flex-row w-full justify-between h-2/5">
        ...
        <div class="wrapImages w-4/5 grayscale hover:grayscale-0">
          <div class="imageContainer3 w-full flex flex-row mb-2">
            <img
              className="w-1/2 p-2"
              src="https://ca.slack-edge.com/T42HA9JJF-U0357SGBF1T-8451feab56a6-512"
            />
            <img
              className="w-1/2 p-2"
              src="http://drive.google.com/uc?export=view&id=1Lfiuf3qPtCgYCkr8qqDAVQRGX1slBVOU"
            />
          ...
          <div class="imageContainer4 flex flex-row w-full">
            ...
            <img
              className="w-1/2 p-2"
              src="https://ca.slack-edge.com/T42HA9JJF-U04P347ND8D-b0788daeeb74-512"
            />
            {
              <img
                className="w-1/2 p-2"
                src="http://drive.google.com/uc?export=view&id=1fjatQHje5Hkwc31wi5k6liLQlZXTubWd"
              />
            }
          </div>
        </div>
      ...
      <div class="wrap my-0 w-full flex flex-row justify-between h-1/5 mb-2">
        ...
        <div class="colorbar w-[10px] bg-primary"></div>
        <div class="flex flex-row justify-around w-4/5 h-full grayscale hover:grayscale-0">
          {/*             <img
              className="w-1/3"
