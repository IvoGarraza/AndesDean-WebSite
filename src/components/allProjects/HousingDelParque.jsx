  ...
  return (
    <div className='flex flex-col sm:flex-row-reverse px-6 my-8'>
      <div className='sm:w-1/2  flex flex-col justify-around text-xl'>
        ...
        <span>Light Steel Framing has gained popularity as a construction method in Argentina in recent years. The typical project scope includes:</span>
        <div className="flex flex-col">
          <div className="flex flex-row items-center">
            <img src={bulletPoint} className="w-4 mr-2"></img>
            <span className="font-bold">Architectural Pack</span>
          </div>
          <span>Schematic Design, Renders, Design Drawings, Permits, Architectural Details.</span>
          <div className="flex flex-row items-center">
            <img src={bulletPoint} className="w-4 mr-2"></img>
            <span className="font-bold">Engineering Pack</span>
          </div>
          <span>Structural calculations for Studs/Wall System, Roofing System, Bracing System, and Slab-on-Grade. Structural Set of Drawings.</span>
          <div className="flex flex-row items-center">
            <img src={bulletPoint} className="w-4 mr-2"></img>
            <span className="font-bold">Design and Detailing Pack</span>
          </div>
          <span>BIM 3D model, Complete set of Assembly Drawings. Complete set of Layout Drawings. Steel Estimation Report.</span>
        </div>
        <div className='py-4'>
